...
public class C05_Runner {
    ...
    public static void main(String[] args) {
        ...
        String str = new String("Java Candir");
                 C04             obje        =             new          C04();
        //classAdi / data turu   isim   atama isareti    keyword       consructor
    ...
    Parametresiz ve body'sinde kod yoktur.

    ONEMLI :
    Bir class'da gorunur bir constructor yoksa
    o class'da default bir contructor vardir
